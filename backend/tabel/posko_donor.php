...
if($op == 'delete'){
    ...
    $sql1       = "delete from posko_donor where id_posko = '$id_posko'";
...
if ($op == 'edit') {
    $id_posko         = $_GET['id_posko'];
    $sql1       = "select * from posko_donor where id_posko = '$id_posko'";
    $q1         = mysqli_query($koneksi, $sql1);
...
if(isset($_POST['simpan'])){
    ...
    if($id_posko && $alamat){
        if ($op == 'edit') {
            $id_posko = $_GET['id_posko'];
            $sql1 = "UPDATE posko_donor SET id_posko='$id_posko', alamat='$alamat' WHERE id_posko='$id_posko'";
            $q1 = mysqli_query($koneksi, $sql1);
            ...
            $sql1 = "INSERT INTO posko_donor (id_posko, alamat) VALUES ('$id_posko', '$alamat')";
            $q1 = mysqli_query($koneksi, $sql1);
                ...
                <div class = "card-body">
                    <form action="" method="POST">
                        <table class="table">
                            ...
                            <tbody>
                                    <?php
                                    $sql2   = "select * from posko_donor order by id_posko asc";
                                    ...
                                    <tr>
                                        ...
                                        <td scope="row">
                                            <a href="posko_donor.php?op=edit&id_posko=<?php echo $id_posko ?>"><button type="button" class="btn btn-warning">Edit</button></a>
                                            <a href="posko_donor.php?op=delete&id_posko=<?php echo $id_posko?>" onclick="return confirm('Hapus Data ?')"><button type="button" class="btn btn-danger">Delete</button></a>            
                                        </td>
                                    </tr>
                                    <?php
                                    }
