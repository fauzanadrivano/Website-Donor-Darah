...
if($op == 'delete'){
    $id     = $_GET['id'];
    $sql1       = "delete from penerima where id = '$id'";
...
if ($op == 'edit') {
    $id               = $_GET['id'];
    $sql1             = "select * from penerima where id = '$id'";
    $q1               = mysqli_query($koneksi, $sql1);
...
if(isset($_POST['simpan'])){
    ...
    if($nama_penerima && $golongan_darah && $alamat && $no_hp && $rumah_sakit){
        if ($op == 'edit') {
            $id = $_GET['id'];
            $sql1 = "UPDATE penerima SET nama_penerima='$nama_penerima', golongan_darah='$golongan_darah', alamat='$alamat', no_hp='$no_hp', rumah_sakit='$rumah_sakit' WHERE id='$id'";
            $q1 = mysqli_query($koneksi, $sql1);
            ...
            $sql1 = "INSERT INTO penerima (nama_penerima, golongan_darah, alamat, no_hp, rumah_sakit) VALUES ('$nama_penerima', '$golongan_darah', '$alamat', '$no_hp', '$rumah_sakit')";
            $q1 = mysqli_query($koneksi, $sql1);
                        ...
                        <table class="table">
                            ...
                            <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td scope="row">
                                            <a href="penerima.php?op=edit&id=<?php echo $id ?>"><button type="button" class="btn btn-warning">Edit</button></a>
                                            <a href="penerima.php?op=delete&id=<?php echo $id?>" onclick="return confirm('Hapus Data ?')"><button type="button" class="btn btn-danger">Delete</button></a>            
                                        </td>
                                    </tr>
                                    <?php
                                    }
